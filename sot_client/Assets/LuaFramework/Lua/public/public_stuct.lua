...
PublicStruct.Const = {
	...
	HERO_MAX_STAR_BREAK = 54,--英雄最大星级突破

	HERO_QH_LEVEL = 5,--潜能强化等级
	WAR_SOUL_TYPE = 4,--战魂类型数量
	WAR_SOUL_MAX_STAR = 10,--战魂最大星级
	...
	RANDOM_SCALE = 1000,
	UI_CLOSE_DELAY = 0.2,
	REMOTE_AREA_ATTACK = 1.5,
	ROUND_NUMBER_BIT = 3,
	REPLAY_MODE_EFFECT_ACTION_HEIGHT = 1,
}
--[[数据类型]]
...
PublicStruct.MS_Each_Anim_Frame = 33
--战斗同步方式
PublicStruct.Fight_Sync_Type = ENUM.EFightSyncType.StateSync
--[[帧同步相关]]
--当前逻辑帧数,帧率
