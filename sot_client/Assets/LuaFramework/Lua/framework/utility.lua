...
function Utility.create_callback_ex(func, autodel, func_param_num, parm1, parm2, parm3, parm4, parm5, parm6)
    ...
    elseif func_param_num == 2 then
        fn = function(func_p1, func_p2)
            func(func_p1, func_p2, parm1, parm2, parm3, parm4, parm5, parm6);
            if autodel then
                _G[name_] = nil
                Utility.callback_list[name_] = nil
            end
    ...
    elseif func_param_num == 3 then
        fn = function(func_p1, func_p2, func_p3)
            func(func_p1, func_p2, func_p3, parm1, parm2, parm3, parm4, parm5, parm6);
            if autodel then
                _G[name_] = nil
                Utility.callback_list[name_] = nil
            end
    ...
    elseif func_param_num == 4 then
        fn = function(func_p1, func_p2, func_p3, func_p4)
            func(func_p1, func_p2, func_p3, func_p4, parm1, parm2, parm3, parm4, parm5, parm6);
            if autodel then
                _G[name_] = nil
                Utility.callback_list[name_] = nil
            end
...
function Utility.create_obj_callback(obj, func, func_param_num, parm1, parm2, parm3, parm4, parm5, parm6)
    ...
    elseif func_param_num == 2 then
        fn = function(func_p1, func_p2)
            func(obj, func_p1, func_p2, parm1, parm2, parm3, parm4, parm5, parm6);
            _G[name_] = nil
            Utility.callback_list[name_] = nil
        end;
    elseif func_param_num == 3 then
        fn = function(func_p1, func_p2, func_p3)
            func(obj, func_p1, func_p2, func_p3, parm1, parm2, parm3, parm4, parm5, parm6);
            _G[name_] = nil
            Utility.callback_list[name_] = nil
        end;
    elseif func_param_num == 4 then
        fn = function(func_p1, func_p2, func_p3, func_p4)
            func(obj, func_p1, func_p2, func_p3, func_p4, parm1, parm2, parm3, parm4, parm5, parm6);
            _G[name_] = nil
            Utility.callback_list[name_] = nil
        end
    end
    ...
    if g_open_bind_callback then
        ...
        if not g_bind_callback_name[obj._className] then
            if obj._className == "" then
                app.log_error("..."..tostring(debug.traceback()))
            end
...
function Utility.clone(src)
    if src == nil then
        app.log_error("Utility.clone--nil "..debug.traceback())
        do return end;
    end
    local dst = { }
    for k, v in pairs(src) do
...
function Utility.getUsualTime(time,match,type)
    ...
    elseif type == 2 then
        local tTime = time-os.time();
        if tTime<0 then
            tTime=0 ;
        end
        str = os.date(match,tTime);
	end
	return str;
end
--[[
...
function Utility.lua_string_split(str, split_char)
    if not str or not split_char then
        app.log_error('Utility.lua_string_split bad str/spliter'..debug.traceback())
    end
...
function Utility.getCnFormatLength(str)
    if type(str) ~= "string" then
        app.log_error('Utility.getCNcharNumber bad str:'..debug.traceback())
        return 0 
    end
...
function Utility.CallFunc(func, parm1, parm2,parm3,parm4,parm5,parm6,parm7,parm8)
    if func == nil then
         app.log_error("Utility.CallFunc: func is nil."..debug.traceback())
        return
    end
...
function Utility.handler(obj, func)
    if obj and func then
        return function(...)  return func(obj, ...) end
    else
        logError("Utility.hanler func but obj or func is nil " .. tostring(obj) .. tostring(func))
    end
end