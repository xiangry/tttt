...
public class Packager {
    ...
    [MenuItem("LuaFramework/Build Android Only Resource", false, 103)]
    public static void BuildAssetBundle()
    {
        BuildAssetResourceRes(BuildTarget.Android);
    }
    ...
    /// 生成绑定素材
    /// </summary>
    public static void BuildAssetResourceRes(BuildTarget target)
    {
        if (Directory.Exists(Util.DataPath))
        {
            Directory.Delete(Util.DataPath, true);
    ...
    static void HandleExampleBundle() {
        ...
        AddBuildMap("prompt" + AppConst.ExtName, "PromptPanel.prefab", "Assets/LuaFramework/Examples/Builds/Prompt");
        AddBuildMap("prompt_item" + AppConst.ExtName, "PromptItem.prefab", "Assets/LuaFramework/Examples/Builds/Prompt");
